...
int angles[3];  // Array to store the three angles
int pos = 0;
const int servoPin = 10;
int stepsPerRevolution = 200 * 20 * 4;  // change this to fit the number of steps per revolution
...
void setMotors(int angles[3]) {

  baseStepper.runToNewPosition(angles[1] * stepsPerRevolution/360);
  shoulderStepper.runToNewPosition(angles[2] * stepsPerRevolution/360);

  pos = map(angles[3], 0, 166, 0, 180);   // Linearly maps 0-166 onto 0-180 for the servo
